...
function main() {
    ...
    ingredient_1.innerText = multiplier * 1.5 //add quantity here
    ingredient_2.innerText = multiplier * 3.5
    ingredient_3.innerText = multiplier * 1
    ingredient_4.innerText = multiplier * 0.25
    ingredient_5.innerText = multiplier * 1.25
    ingredient_6.innerText = multiplier * 3
    ingredient_7.innerText = multiplier * 1
}
